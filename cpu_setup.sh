...
sed -i '451i\  context->setTimeout(std::chrono::seconds(60));' xla/xla/pjrt/cpu/gloo_collectives.cc
echo "Building jaxlib"
echo "ls $(pwd)"
ls $(pwd)
python build/build.py --bazel_options=--override_repository=xla=$(pwd)
